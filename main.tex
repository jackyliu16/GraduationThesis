...
% 在这里填写你的相关信息
\newcommand{\yourDept}{\hide{软件学院}}
\newcommand{\yourMajor}{\hide{软件工程}}
\newcommand{\yourName}{\hide{刘逸珑}}
\newcommand{\yourClass}{\hide{2020级中英一班}}
\newcommand{\yourMentor}{\hide{刘刚}}
\newcommand{\studentID}{\hide{20200740029}}
...
本次毕业设计实现的底层网卡驱动在最优情况下可以实现 984.92 MBps 的以太网帧通信， 嵌合 ArceOS 上层以太网协议栈之后，
UDP 通信速率还能达到 74.49 MBps，FPM383C 串口传输驱动能正常工作。本次毕业设计集合上述各种驱动完成了一个最为精简的，
涵盖了考勤系统所有必要模块的完整指纹考勤系统。在此系统上可以实现在各打卡终端中打卡联网记录，
且上位机中可以根据人事考勤需求对于用户和对应的指纹模板进行联网增删改查等功能。
...
\hide{\includepdf[pages={1,2}]{./imgs/成绩评定表.pdf}}
